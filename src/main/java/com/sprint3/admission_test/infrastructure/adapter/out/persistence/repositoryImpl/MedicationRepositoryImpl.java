...
public class MedicationRepositoryImpl implements IMedicationRepository {
    ...
    @Override
    public List<Medication> findByCategoryNameAndExpirationDateAfter(String category, LocalDate expirationDate) {
        return medicationJpaRepository.findByCategoryNameAndExpirationDateAfter(category, expirationDate);
    }
}
